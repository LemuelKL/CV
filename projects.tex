...
\resumeSubItem{WinMaths (Functional Programming, Code Generation, Typesetting)}{

E-learning platform that generates random Mathematics and Physics MCQs based on templates written in JavaScript \& HTML \& KaTeX. Incremental development. (Jointly developed and in production since 2019)}
...
\resumeSubItem{Duckietown (Computer Vision, Reinforced Learning, Self-driving)}{
