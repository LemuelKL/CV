...
A shell which supports command parsing, program execution, signals handling, multiple background processes, arbitrary number of piped processes and process statistics in any combinations. 
}
...
Generates random Mathematics and Physics MCQs based on templates written in JavaScript \& HTML \& KaTeX. Incremental development. (In production since 2019)}
...
Invited to showcase COMP3329 Computer Game Design and Programming course work project HackOS, an educational offensive cyber-security simulator.}
