...
Developed with Qt and SQLite, a GUI program that provides CRUD functionalities to common library administration, such as book categorization, borrow/return management, mass book record import, barcode scanning, and overdue alert. Object-oriented and separatedly compiled. (May 2019)}
...
Developed a React Native app to display a summary of COVID19 travel restrictions by tapping an origin \& destination on a world map.}
